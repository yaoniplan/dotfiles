-- https://github.com/fbriere/mpv-scripts/blob/master/scripts/brace-expand.lua
-- `mpv https://example.com/sample.mp4?p={1..15}` # This is my usage
-- Same as `mpv https://example.com/sample.mp4?p=1 https://example.com/sample.mp4?p=2 https://example.com/sample.mp4?p=3 ...`
--[[
